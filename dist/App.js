...
/***/ function(module, exports, __webpack_require__) {
	...
	var If = __webpack_require__(3).If;
	var Else = __webpack_require__(3).Else;
	var ElseIf = __webpack_require__(3).ElseIf;
	
	/*
	 * Dudes Demo
	 */
	
	var DudesDemo = __webpack_require__(1);
	 ...
	 * Table Demo
	 */
	var TableDemo = __webpack_require__(2);
	  ...
	  render: function () {
	    return (
	      React.createElement("div", {className: "App"}, 
	        React.createElement("button", {className: "toggle-button", onClick: this._toggleDisplay}, 
	          "Toggle demo display"
	        ), 
	        React.createElement(If, {cond: this.state.displayDudesDemo}, 
	          React.createElement(DudesDemo, {
	            dudes: myDudes, 
	            dudesPerRow: 3}
	          ), 
	        React.createElement(Else, null), 
	          React.createElement(TableDemo, {
	            headerFirst: true, 
	            data: data.split('\n'), 
	            delimiter: "|"}
	          )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dudes = React.createClass({displayName: 'Dudes',
	  render: function () {
	    var initialRows = [];
	    ...
	    var dudes = this.props.dudes.reduce(function (aggregate, input, i) {
	      ...
	      aggregate.rows[row].push(
	        React.createElement("td", {key: input.name, className: classNames.join(' ')}, 
	          input.name
	        )
	      );
	      return aggregate;
	      ...
	      return (
	        React.createElement("tr", {key: i, className: "dudes-row"}, 
	          row
	        )
	      );
	    });
	    return (
	      React.createElement("table", {className: "dude-table"}, 
	...
	var DudesDemo = React.createClass({displayName: 'DudesDemo',
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getConvertStringToElements(delimiter) {
	  return function (string, constructor) {
	    return string.split(delimiter).map(function (a, i) {
	      return constructor(
	        React.createElement("span", {className: "table-demo-span"}, a),
	        i
	      );
	    });
	  }
	...
	function thConstructor(a, i) {
	  return (React.createElement("th", {key: i}, a));
	}
	
	function tdConstructor(a, i) {
	  return (React.createElement("td", {key: i}, a));
	}
	
	var TableDemo = React.createClass({displayName: 'TableDemo',
	  render: function () {
	    ...
	    return (
	      React.createElement("table", {className: "table-demo-table"}, 
	        React.createElement("thead", {className: "table-demo-head"}, 
	          output.header
	        ), 
	        React.createElement("tbody", {className: "table-demo-body"}, 
	          output.rows
	        )
	      )
	    );
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports.If = __webpack_require__(5);
	module.exports.Else = __webpack_require__(6);
	module.exports.ElseIf = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(4);
	var Else = __webpack_require__(6);
	var ElseIf = __webpack_require__(7);
	...
	var If = React.createClass({displayName: 'If',
	  render: function () {
	    ...
	    return (
	      React.createElement("div", {className: output.className}, 
	        output.children
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var Else = React.createClass({displayName: 'Else',
...
/***/ function(module, exports, __webpack_require__) {
	...
	/**
	 * ElseIf component to be used with If
	 */
	var ElseIf = React.createClass({displayName: 'ElseIf',
	  // don't render anything with ElseIf
	  render: function () {
	    return null;
	  }
	});
